...
class Sale{
     ...
     * Essa função deverá calcular o preço total do produto
     * com base em um parcelamento sob regime de juros composto
     * @param float $tax
    ...
    /**
     *  Essa função irá calcular o total da venda,
     *  onde serão somados os subtotais de cada produto 
     *  relacionado a venda em questão
     * @return float
     */
